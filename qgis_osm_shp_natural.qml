...
<qgis version="2.8.1-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{8a753a52-bfd9-46fb-8618-3ee16d804969}">
      <rule filter="type = 'forest'" key="{05b44bce-1a3b-4ac4-a0a0-6e4d11d525bf}" symbol="0" label="forest"/>
      <rule filter="type = 'park'" key="{00259f4c-9818-4a7c-a359-bb49d8f16bd2}" label="park">
        <rule scalemaxdenom="20000" key="{19b9e844-370e-4eaf-ba65-3e137c07d067}" symbol="1" scalemindenom="1" label="1 - 20000"/>
        <rule scalemaxdenom="10000000" key="{450eb176-143b-481c-9e80-60e469c69152}" symbol="2" scalemindenom="20000" label="20000 - 10000000"/>
      </rule>
      <rule filter="type IN ('water','riverbank')" key="{8ef8ae81-857e-4189-a113-d608a2916c0e}" symbol="3" label="water"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" type="fill" name="1">
        <layer pass="0" class="ShapeburstFill" locked="0">
          ...
          <prop k="gradient_color2" v="153,194,137,255"/>
